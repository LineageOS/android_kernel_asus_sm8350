...
static int get_test_threshold_mc_sc(void)
{
	...
	fts_init_buffer(thr->noise_min, thr->basic.noise_min, node_num, false,
			0, 0);
	...
	fts_init_buffer(thr->scap_noise_off_min, thr->basic.scap_noise_off_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_off_max, thr->basic.scap_noise_off_max,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_on_min, thr->basic.scap_noise_on_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_on_max, thr->basic.scap_noise_on_max,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_hi_min, thr->basic.scap_noise_hi_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_hi_max, thr->basic.scap_noise_hi_max,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_hov_min, thr->basic.scap_noise_hov_min,
			sc_num, false, 0, 0);
	fts_init_buffer(thr->scap_noise_hov_max, thr->basic.scap_noise_hov_max,
			sc_num, false, 0, 0);
